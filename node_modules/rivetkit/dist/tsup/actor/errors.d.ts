import { D as DeconstructedError } from '../utils-fwx3o3K9.js';
import 'hono';
...
declare class IncomingMessageTooLong extends ActorError {
    constructor();
}
declare class OutgoingMessageTooLong extends ActorError {
    constructor();
}
...
declare class QueueFull extends ActorError {
    constructor(limit: number);
}
declare class QueueMessageTooLarge extends ActorError {
    constructor(size: number, limit: number);
}
declare class QueueMessageInvalid extends ActorError {
    constructor(path?: string);
}
declare class EventPayloadInvalid extends ActorError {
    constructor(name: string, issues?: unknown[]);
}
declare class QueuePayloadInvalid extends ActorError {
    constructor(name: string, issues?: unknown[]);
}
declare class QueueCompletionPayloadInvalid extends ActorError {
    constructor(name: string, issues?: unknown[]);
}
declare class QueueAlreadyCompleted extends ActorError {
    constructor();
}
declare class QueuePreviousMessageNotCompleted extends ActorError {
    constructor();
}
declare class QueueCompleteNotConfigured extends ActorError {
    constructor(name: string);
}
declare class ActorAborted extends ActorError {
    constructor();
}
/**
...
declare class RequestHandlerNotDefined extends ActorError {
    constructor();
}
...
declare class InvalidCanSubscribeResponse extends ActorError {
    constructor();
}
declare class InvalidCanPublishResponse extends ActorError {
    constructor();
}
...
declare class RestrictedFeature extends ActorError {
    constructor(feature: string);
}
declare class Forbidden extends ActorError {
    constructor();
}
declare class EndpointMismatch extends ActorError {
    constructor(expected: string, received: string);
}
declare class NamespaceMismatch extends ActorError {
    constructor(expected: string, received: string);
}

export { ActionNotFound, ActionTimedOut, ActorAborted, ActorDuplicateKey, ActorError, ActorNotFound, ActorStopping, ConnStateNotEnabled, DatabaseNotEnabled, EndpointMismatch, EventPayloadInvalid, FeatureNotImplemented, Forbidden, INTERNAL_ERROR_CODE, INTERNAL_ERROR_DESCRIPTION, IncomingMessageTooLong, InternalError, type InternalErrorMetadata, InvalidActionRequest, InvalidCanPublishResponse, InvalidCanSubscribeResponse, InvalidEncoding, InvalidParams, InvalidQueryJSON, InvalidRequest, InvalidRequestHandlerResponse, InvalidStateType, type InvalidStateTypeOptions, MalformedMessage, MissingActorHeader, NamespaceMismatch, OutgoingMessageTooLong, ProxyError, QueueAlreadyCompleted, QueueCompleteNotConfigured, QueueCompletionPayloadInvalid, QueueFull, QueueMessageInvalid, QueueMessageTooLarge, QueuePayloadInvalid, QueuePreviousMessageNotCompleted, RequestHandlerNotDefined, RestrictedFeature, RouteNotFound, StateNotEnabled, USER_ERROR_CODE, Unreachable, Unsupported, UserError, type UserErrorOptions, VarsNotEnabled, WebSocketHandlerNotDefined, WebSocketsNotEnabled };
