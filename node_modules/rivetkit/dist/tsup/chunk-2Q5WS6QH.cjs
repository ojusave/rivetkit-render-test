...
function deconstructError(error, logger2, extraLog, exposeInternalError = false) {
  ...
  let message;
  let metadata;
  if (_chunkL47L3ZWJcjs.ActorError.isActorError(error) && error.public) {
    ...
    if (_chunkL47L3ZWJcjs.ActorError.isActorError(error)) {
      statusCode = 500;
      public_ = false;
      group = error.group;
      code = error.code;
      ...
      public_ = false;
      group = "rivetkit";
      code = _chunkL47L3ZWJcjs.INTERNAL_ERROR_CODE;
      message = getErrorMessage(error);
      logger2.info({
        msg: "internal error",
        group,
    ...
    group = "rivetkit";
    code = _chunkL47L3ZWJcjs.INTERNAL_ERROR_CODE;
    message = _chunkL47L3ZWJcjs.INTERNAL_ERROR_DESCRIPTION;
    metadata = {
