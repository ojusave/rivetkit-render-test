...
var ConnContext = class extends _chunkGVBTEL2Dcjs.ActorContext {
  /**
   * @internal
   */
...
var ConnInitContext = class extends _chunkGVBTEL2Dcjs.ActorContext {
  /**
...
function contentTypeForEncoding(encoding) {
  if (encoding === "json") {
    ...
    _chunk2Q5WS6QHcjs.assertUnreachable.call(void 0, encoding);
  }
}
...
var _barets = require('@rivetkit/bare-ts'); var bare = _interopRequireWildcard(_barets); var bare2 = _interopRequireWildcard(_barets); var bare3 = _interopRequireWildcard(_barets); var bare4 = _interopRequireWildcard(_barets); var bare5 = _interopRequireWildcard(_barets); var bare6 = _interopRequireWildcard(_barets); var bare7 = _interopRequireWildcard(_barets);
...
var TO_SERVER_VERSIONED2 = _vbare.createVersionedDataHandler.call(void 0, {
...
var TO_CLIENT_VERSIONED2 = _vbare.createVersionedDataHandler.call(void 0, {
  deserializeVersion: (bytes, version) => {
    switch (version) {
      case 1:
...
async function handleAction(c, config8, actorDriver, actionName, actorId) {
  ...
  if (arrayBuffer.byteLength > config8.maxIncomingMessageSize) {
    throw new (0, _chunkL47L3ZWJcjs.IncomingMessageTooLong)();
  }
  ...
  for (let attempt = 0; attempt < maxAttempts; attempt++) {
    ...
    try {
      ...
      const shouldRetry = error instanceof _chunkL47L3ZWJcjs.InternalError && error.message === "Actor is stopping" && attempt < maxAttempts - 1;
      if (shouldRetry) {
  ...
  if (!outputReady) {
    throw new (0, _chunkL47L3ZWJcjs.InternalError)("Action did not complete");
  }
  const serialized = serializeWithEncoding(
    encoding,
    output,
    ...
    (value) => ({
      output: _chunk2Q5WS6QHcjs.bufferToArrayBuffer.call(void 0, cbor2.encode(value))
    })
  );
  ...
  if (messageSize > config8.maxOutgoingMessageSize) {
    throw new (0, _chunkL47L3ZWJcjs.OutgoingMessageTooLong)();
  }
...
async function handleQueueSend(c, config8, actorDriver, actorId, queueName) {
  ...
  const request = deserializeWithEncoding(
    ...
    (json) => json,
    (bare8) => ({
      name: _nullishCoalesce(bare8.name, () => ( void 0)),
      body: cbor2.decode(new Uint8Array(bare8.body)),
      wait: _nullishCoalesce(bare8.wait, () => ( void 0)),
      timeout: bare8.timeout !== null && bare8.timeout !== void 0 ? Number(bare8.timeout) : void 0
    })
  );
  const name = _nullishCoalesce(queueName, () => ( request.name));
  if (!name) {
    throw new (0, _chunkL47L3ZWJcjs.InvalidRequest)("missing queue name");
  }
  const actor = await actorDriver.loadActor(actorId);
  if (!_chunkGVBTEL2Dcjs.hasSchemaConfigKey.call(void 0, actor.config.queues, name)) {
    actor.rLog.warn({
    ...
    const ignoredResponse = serializeWithEncoding(
      ...
      (value) => ({
        status: value.status,
        response: value.response !== void 0 ? _chunk2Q5WS6QHcjs.bufferToArrayBuffer.call(void 0, cbor2.encode(value.response)) : null
      })
    );
...
function getRequestEncoding(req) {
  ...
  if (!result.success) {
    throw new (0, _chunkL47L3ZWJcjs.InvalidEncoding)(encodingParam);
  }
  return result.data;
}
function getRequestExposeInternalError(_req) {
  return _chunk2Q5WS6QHcjs.getEnvUniversal.call(void 0, "RIVET_EXPOSE_ERRORS") === "1" || _chunk2Q5WS6QHcjs.getEnvUniversal.call(void 0, "NODE_ENV") === "development";
}
function getRequestConnParams(req) {
  ...
  try {
    ...
    throw new (0, _chunkL47L3ZWJcjs.InvalidParams)(
      `Invalid params JSON: ${_chunk2Q5WS6QHcjs.stringifyError.call(void 0, err)}`
    );
  }
}
...
var defaultTokenFn = () => {
  const envToken = _chunk2Q5WS6QHcjs.getRivetkitInspectorToken.call(void 0, );
  if (envToken) {
    return envToken;
  }
  return "";
...
var defaultEnabled = () => {
  return _chunk2Q5WS6QHcjs.isDev.call(void 0, ) || !_chunk2Q5WS6QHcjs.getRivetkitInspectorDisable.call(void 0, );
};
var InspectorConfigSchema = _v4.z.object({
   ...
   */
  token: _v4.z.custom().optional().default(() => defaultTokenFn),
  /**
   ...
   */
  defaultEndpoint: _v4.z.string().optional()
}).optional().default(() => ({
...
var DriverConfigSchema = _v4.z.object({
  /** Machine-readable name to identify this driver by. */
  name: _v4.z.string(),
  displayName: _v4.z.string(),
   ...
   * */
  autoStartActorDriver: _v4.z.boolean()
});
...
var RunnerConfigSchema = _v4.z.object({
  // MARK: Runner
  totalSlots: _v4.z.number().default(() => _nullishCoalesce(_chunk2Q5WS6QHcjs.getRivetTotalSlots.call(void 0, ), () => ( 1e5))),
  runnerName: _v4.z.string().default(() => _nullishCoalesce(_chunk2Q5WS6QHcjs.getRivetRunner.call(void 0, ), () => ( "default"))),
  runnerKey: _v4.z.string().optional().transform((x) => _nullishCoalesce(x, () => ( _chunk2Q5WS6QHcjs.getRivetRunnerKey.call(void 0, )))),
  version: _v4.z.number().default(() => _nullishCoalesce(_chunk2Q5WS6QHcjs.getRivetRunnerVersion.call(void 0, ), () => ( 1)))
});

// src/registry/config/serverless.ts

var ConfigureRunnerPoolSchema = _v4.z.object({
  name: _v4.z.string().optional(),
  url: _v4.z.string(),
...
var ServerlessConfigSchema = _v4.z.object({
   ...
   */
  spawnEngine: _v4.z.boolean().default(() => _chunk2Q5WS6QHcjs.getRivetRunEngine.call(void 0, )),
  /** @experimental */
  engineVersion: _v4.z.string().optional().default(() => _nullishCoalesce(_chunk2Q5WS6QHcjs.getRivetRunEngineVersion.call(void 0, ), () => ( _chunk2Q5WS6QHcjs.VERSION))),
  /**
   * @experimental
   *
   ...
   */
  publicEndpoint: _v4.z.string().optional().transform((val) => _nullishCoalesce(val, () => ( _chunk2Q5WS6QHcjs.getRivetPublicEndpoint.call(void 0, )))),
  /**
   ...
   */
  publicToken: _v4.z.string().optional().transform((val) => _nullishCoalesce(val, () => ( _chunk2Q5WS6QHcjs.getRivetPublicToken.call(void 0, ))))
...
var RegistryConfigSchema = _zod.z.object({
   ...
   */
  storagePath: _zod.z.string().optional().transform((val) => _nullishCoalesce(val, () => ( _chunk2Q5WS6QHcjs.getRivetkitStoragePath.call(void 0, )))),
  // MARK: Networking
  /** @experimental */
   ...
   */
  endpoint: _zod.z.string().optional().transform((val) => _nullishCoalesce(_nullishCoalesce(val, () => ( _chunk2Q5WS6QHcjs.getRivetEngine.call(void 0, ))), () => ( _chunk2Q5WS6QHcjs.getRivetEndpoint.call(void 0, )))),
  token: _zod.z.string().optional().transform((val) => _nullishCoalesce(val, () => ( _chunk2Q5WS6QHcjs.getRivetToken.call(void 0, )))),
  namespace: _zod.z.string().optional().transform((val) => _nullishCoalesce(val, () => ( _chunk2Q5WS6QHcjs.getRivetNamespace.call(void 0, )))),
   ...
   * Auto-determined based on endpoint and NODE_ENV if not specified.
   */
  serveManager: _zod.z.boolean().optional(),
  /**
   * @experimental
   *
   ...
   */
  managerBasePath: _zod.z.string().optional().default("/"),
  /**
   * @experimental
   *
  ...
  const namespace = _nullishCoalesce(_nullishCoalesce((parsedEndpoint == null ? void 0 : parsedEndpoint.namespace), () => ( config8.namespace)), () => ( "default"));
  const token = _nullishCoalesce((parsedEndpoint == null ? void 0 : parsedEndpoint.token), () => ( config8.token));
  ...
  const serveManager = _nullishCoalesce(config8.serveManager, () => ( (isDevEnv && !endpoint)));
  const publicEndpoint = _nullishCoalesce((parsedPublicEndpoint == null ? void 0 : parsedPublicEndpoint.endpoint), () => ( (isDevEnv && (serveManager || config8.serverless.spawnEngine) ? `http://127.0.0.1:${config8.managerPort}` : void 0)));
  const publicNamespace = parsedPublicEndpoint == null ? void 0 : parsedPublicEndpoint.namespace;
  const publicToken = _nullishCoalesce((parsedPublicEndpoint == null ? void 0 : parsedPublicEndpoint.token), () => ( config8.serverless.publicToken));
...
function buildActorNames(config8) {
  return Object.fromEntries(
    Object.keys(config8.use).map((actorName) => {
      ...
      const runMeta = _chunkGVBTEL2Dcjs.getRunMetadata.call(void 0, definition.config.run);
      const metadata = {};
...
var DocInspectorConfigSchema = _zod.z.object({
  enabled: _zod.z.boolean().optional().describe(
  ...
  defaultEndpoint: _zod.z.string().optional().describe(
...
var DocServerlessConfigSchema = _zod.z.object({
  spawnEngine: _zod.z.boolean().optional().describe(
...
var DocRegistryConfigSchema = _zod.z.object({
  ...
  storagePath: _zod.z.string().optional().describe(
  ...
  logging: _zod.z.object({
    level: _chunk2Q5WS6QHcjs.LogLevelSchema.optional().describe(
  ...
  serveManager: _zod.z.boolean().optional().describe(
...
// src/common/router.ts
function logger() {
  return _chunk2Q5WS6QHcjs.getLogger.call(void 0, "router");
}
function loggerMiddleware(logger5) {
  return async (c, next) => {
    ...
    logger5.debug({
      ...
      ..._chunk2Q5WS6QHcjs.getLogHeaders.call(void 0, ) ? { allHeaders: JSON.stringify(c.req.header()) } : {}
    });
  };
}
...
function handleRouteError(error, c) {
  ...
  const { statusCode, group, code, message, metadata } = _chunk2Q5WS6QHcjs.deconstructError.call(void 0, 
    error,
    logger(),
    {
      method: c.req.method,
  ...
  const output = serializeWithEncoding(
    ...
    (value) => ({
      ...
      code: value.code,
      message: value.message,
      metadata: value.metadata ? _chunk2Q5WS6QHcjs.bufferToArrayBuffer.call(void 0, cbor3.encode(value.metadata)) : null
    })
  );
...
async function getInspectorDir() {
  ...
  extractionPromise = (async () => {
    ...
    await _tar.extract.call(void 0, { file: tarball, cwd: dest });
    extractedDir = dest;
    return dest;
  })();
...
var RivetIdSchema = _v4.z.string();

// src/manager-api/actors.ts
var ActorSchema = _v4.z.object({
  actor_id: RivetIdSchema,
  name: _v4.z.string(),
  key: _v4.z.string(),
  namespace_id: RivetIdSchema,
  runner_name_selector: _v4.z.string(),
  create_ts: _v4.z.number(),
  connectable_ts: _v4.z.number().nullable().optional(),
  destroy_ts: _v4.z.number().nullable().optional(),
  sleep_ts: _v4.z.number().nullable().optional(),
  start_ts: _v4.z.number().nullable().optional(),
  error: _v4.z.unknown().nullable().optional()
});
var ActorNameSchema = _v4.z.object({
  metadata: _v4.z.record(_v4.z.string(), _v4.z.unknown())
});
var ActorsListResponseSchema = _v4.z.object({
  actors: _v4.z.array(ActorSchema)
});
var ActorsCreateRequestSchema = _v4.z.object({
  datacenter: _v4.z.string().optional(),
  name: _v4.z.string(),
  runner_name_selector: _v4.z.string(),
  crash_policy: _v4.z.string(),
  key: _v4.z.string().nullable().optional(),
  input: _v4.z.string().nullable().optional()
});
var ActorsCreateResponseSchema = _v4.z.object({
  actor: ActorSchema
});
var ActorsGetOrCreateRequestSchema = _v4.z.object({
  datacenter: _v4.z.string().optional(),
  name: _v4.z.string(),
  key: _v4.z.string(),
  runner_name_selector: _v4.z.string(),
...
var ActorsGetOrCreateResponseSchema = _v4.z.object({
  actor: ActorSchema,
  created: _v4.z.boolean()
});
var ActorsDeleteResponseSchema = _v4.z.object({});
var ActorsListNamesResponseSchema = _v4.z.object({
  names: _v4.z.record(_v4.z.string(), ActorNameSchema)
});
var ActorsKvGetResponseSchema = _v4.z.object({
  value: _v4.z.string().nullable()
});

// src/registry/log.ts
function logger2() {
  return _chunk2Q5WS6QHcjs.getLogger.call(void 0, "registry");
}
...
async function crossPlatformServe(config8, managerPort, app, runtime = _chunk2Q5WS6QHcjs.detectRuntime.call(void 0, )) {
...
var _encoding = require('@rivetkit/traces/encoding');

// src/inspector/log.ts
function inspectorLogger() {
  return _chunk2Q5WS6QHcjs.getLogger.call(void 0, "inspector");
}
        ...
        if (message.body.tag === "PatchStateRequest") {
          ...
          sendMessage(ws, {
            body: {
              ...
              val: {
                rid: id,
                payload: _chunk2Q5WS6QHcjs.bufferToArrayBuffer.call(void 0, 
          ...
          _chunk2Q5WS6QHcjs.assertUnreachable.call(void 0, message.body);
        }
      } catch (error) {
        inspectorLogger().warn(
          { error },
...
function sendMessage(ws, message) {
  ws.send(
    _chunkNIYZDWMWcjs.TO_CLIENT_VERSIONED.serializeWithEmbeddedVersion(
      message,
      _chunkNIYZDWMWcjs.CURRENT_VERSION
    )
  );
}
function receiveMessage(data) {
  return _chunkNIYZDWMWcjs.TO_SERVER_VERSIONED.deserializeWithEmbeddedVersion(new Uint8Array(data));
}
...
function createRawWebSocketDriver(hibernatable, closePromise) {
  ...
  const driver = {
    ...
    disconnect: async (_actor, _conn, reason) => {
      if (!websocket) {
        _chunkGVBTEL2Dcjs.loggerWithoutContext.call(void 0, ).warn(
    ...
    getConnectionReadyState: (_actor, _conn) => {
      return _nullishCoalesce((websocket == null ? void 0 : websocket.readyState), () => ( 0)) /* CONNECTING */;
    }
  };
  return {
    driver,
...
var StateManager = class {
  ...
  constructor(conn, data) {
    ...
    if ("ephemeral" in data) {
      ...
      const persist = _onchange2.default.call(void 0, 
        persistRaw,
      ...
      _chunkGVBTEL2Dcjs.assertUnreachable.call(void 0, data);
    }
  }
  /**
  ...
  get ephemeralData() {
    if ("hibernatable" in this.#data) {
      ...
      return _chunkGVBTEL2Dcjs.assertUnreachable.call(void 0, this.#data);
    }
  }
  ...
  hibernatableDataOrError() {
    ...
    _invariant2.default.call(void 0, hibernatable, "missing hibernatable data");
    return hibernatable;
  }
  ...
  #validateStateEnabled() {
    if (!this.#conn[CONN_ACTOR_SYMBOL].connStateEnabled) {
      throw new (0, _chunkL47L3ZWJcjs.ConnStateNotEnabled)();
    }
  }
  #handleChange(path, value) {
    if (path.startsWith("state")) {
      ...
      if (!_chunk2Q5WS6QHcjs.isCborSerializable.call(void 0, 
        ...
        throw new (0, _chunkL47L3ZWJcjs.InvalidStateType)({
...
var Conn = (_class = class {
   ...
   **/
  __init() {this[CONN_CONNECTED_SYMBOL] = false}
  /**
  ...
  #assertConnected() {
    if (!this[CONN_CONNECTED_SYMBOL])
      throw new (0, _chunkL47L3ZWJcjs.InternalError)(
   ...
   * @protected
   */
  constructor(actor, data) {;_class.prototype.__init.call(this);_class.prototype.__init2.call(this);
    this.#actor = actor;
  ...
  send(eventName, ...args) {
    ...
    if (this.#actor.config.events !== void 0 && !_chunkGVBTEL2Dcjs.hasSchemaConfigKey.call(void 0, this.#actor.config.events, eventName)) {
      this.#actor.rLog.warn({
    ...
    const result = _chunkGVBTEL2Dcjs.validateSchemaSync.call(void 0, 
      this.#actor.config.events,
      eventName,
      payload
    );
    if (!result.success) {
      throw new (0, _chunkL47L3ZWJcjs.EventPayloadInvalid)(eventName, result.issues);
    }
      ...
      new CachedSerializer(
        ...
        (value) => ({
          body: {
            ...
            val: {
              name: value.name,
              args: _chunk2Q5WS6QHcjs.bufferToArrayBuffer.call(void 0, cbor4.encode(value.args))
            }
          }
        })
      )
...
function getValueLength(value) {
  if (typeof value === "string") {
    ...
    _chunk2Q5WS6QHcjs.assertUnreachable.call(void 0, value);
  }
}
async function inputDataToBuffer(data) {
  if (typeof data === "string") {
    ...
    throw new (0, _chunkL47L3ZWJcjs.MalformedMessage)();
  }
}
  ...
  try {
    if (message.body.tag === "ActionRequest") {
      if (handler.onExecuteAction === void 0) {
        throw new (0, _chunkL47L3ZWJcjs.Unsupported)("Action");
      }
        ...
        new CachedSerializer(
          ...
          (value) => ({
            body: {
              ...
              val: {
                id,
                output: _chunk2Q5WS6QHcjs.bufferToArrayBuffer.call(void 0, cbor5.encode(value))
              }
            }
          })
        )
      ...
      if (handler.onSubscribe === void 0 || handler.onUnsubscribe === void 0) {
        throw new (0, _chunkL47L3ZWJcjs.Unsupported)("Subscriptions");
      }
    ...
    const { group, code, message: message2, metadata } = _chunk2Q5WS6QHcjs.deconstructError.call(void 0, 
      error,
      actor.rLog,
      {
      ...
      _chunk2Q5WS6QHcjs.getEnvUniversal.call(void 0, "RIVET_EXPOSE_ERRORS") === "1" || _chunk2Q5WS6QHcjs.getEnvUniversal.call(void 0, "NODE_ENV") === "development"
    );
    actor.rLog.debug({
        ...
        (value) => ({
          body: {
            ...
            val: {
              ...
              code: value.code,
              message: value.message,
              metadata: value.metadata ? _chunk2Q5WS6QHcjs.bufferToArrayBuffer.call(void 0, 
...
async function routeWebSocket(request, requestPath, requestHeaders, config8, actorDriver, actorId, encoding, parameters, gatewayId, requestId, isHibernatable, isRestoringHibernatable) {
  ...
  try {
    ...
    const closePromiseResolvers = _chunk2Q5WS6QHcjs.promiseWithResolvers.call(void 0, (reason) => _chunkGVBTEL2Dcjs.loggerWithoutContext.call(void 0, ).warn({ msg: "unhandled websocket close promise rejection", reason }));
    ...
    const { group, code } = _chunk2Q5WS6QHcjs.deconstructError.call(void 0, 
      error,
      _chunkGVBTEL2Dcjs.loggerWithoutContext.call(void 0, ),
      {},
      exposeInternalError
    );
    if (createdConn) {
  ...
  return {
    ...
    onError: (_error) => {
      try {
        ...
        _chunk2Q5WS6QHcjs.deconstructError.call(void 0, 
          error,
          actor.rLog,
          { wsEvent: "error" },
          exposeInternalError
...
async function handleRawWebSocket(setWebSocket, { request, actor, closePromiseResolvers, conn }) {
  return {
    ...
    onRestore: (wsContext) => {
      ...
      _invariant2.default.call(void 0, ws, "missing wsContext.raw");
      setWebSocket(ws);
    },
...
// src/manager/log.ts
function logger4() {
  return _chunk2Q5WS6QHcjs.getLogger.call(void 0, "actor-manager");
}
...
async function handleWebSocketGatewayPathBased(config8, managerDriver, c, actorPathInfo, getUpgradeWebSocket) {
  ...
  if (!upgradeWebSocket) {
    throw new (0, _chunkL47L3ZWJcjs.WebSocketsNotEnabled)();
  }
...
async function createTestWebSocketProxy(proxyToActorWsPromise) {
  ...
  } = _chunk2Q5WS6QHcjs.promiseWithResolvers.call(void 0, (reason) => logger4().warn({ msg: "unhandled client websocket promise rejection", reason }));
  try {
...
function buildManagerRouter(config8, managerDriver, getUpgradeWebSocket, runtime = "node") {
  return createRouter(config8.managerBasePath, (router) => {
    ...
    });
    {
      const route = _zodopenapi.createRoute.call(void 0, {
        ...
        request: {
          query: _v4.z.object({
            name: _v4.z.string().optional(),
            actor_ids: _v4.z.string().optional(),
    ...
    }
    {
      ...
      router.openapi(route, async (c) => {
        if (_chunk2Q5WS6QHcjs.isDev.call(void 0, ) && !config8.token) {
          logger4().warn({
        ...
        if (!_chunk2Q5WS6QHcjs.isDev.call(void 0, )) {
          if (!config8.token) {
          ...
          if (timingSafeEqual(
            ...
            throw new (0, _chunkL47L3ZWJcjs.Forbidden)();
          }
        }
    ...
    if (config8.test.enabled) {
      router.post(".test/inline-driver/call", async (c) => {
        ...
        try {
          ...
          const err = _chunk2Q5WS6QHcjs.deconstructError.call(void 0, rawErr, logger4(), {}, true);
          response = { err };
        }
      ...
      router.all(".test/inline-driver/send-request/*", async (c) => {
        ...
        try {
          ...
          const err = _chunk2Q5WS6QHcjs.deconstructError.call(void 0, error, logger4(), {}, true);
          return c.json(
            {
              error: {
                code: err.code,
...
function createApiActor(actor) {
  return {
    ...
    create_ts: _nullishCoalesce(actor.createTs, () => ( Date.now())),
    connectable_ts: _nullishCoalesce(actor.connectableTs, () => ( null)),
    destroy_ts: _nullishCoalesce(actor.destroyTs, () => ( null)),
    sleep_ts: _nullishCoalesce(actor.sleepTs, () => ( null)),
    start_ts: _nullishCoalesce(actor.startTs, () => ( null))
  };
}
...
var QUEUE_METADATA_VERSIONED = _vbare.createVersionedDataHandler.call(void 0, {
  deserializeVersion: (bytes, version) => {
    switch (version) {
      case 4:
...
var QUEUE_MESSAGE_VERSIONED = _vbare.createVersionedDataHandler.call(void 0, {
  deserializeVersion: (bytes, version) => {
    switch (version) {
      case 4:
...
function serializeEmptyPersistData(input) {
  const persistData = {
    input: input !== void 0 ? _chunk2Q5WS6QHcjs.bufferToArrayBuffer.call(void 0, cbor7.encode(input)) : null,
    hasInitialized: false,
    state: _chunk2Q5WS6QHcjs.bufferToArrayBuffer.call(void 0, cbor7.encode(void 0)),
    scheduledEvents: []
  };
...
function getInitialActorKvState(input) {
  ...
  return [[_chunkGVBTEL2Dcjs.KEYS.PERSIST_DATA, persistData]];
}
...
//# sourceMappingURL=chunk-TTVNEKBE.cjs.map