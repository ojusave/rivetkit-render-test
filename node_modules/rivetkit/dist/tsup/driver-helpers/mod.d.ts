import { R as RegistryConfig, a_ as ManagerDriver } from '../config-Qj-zLJPc.js';
export { A as ActorDriver, a$ as ActorInstance, b0 as ActorOutput, b as AnyActorInstance, b1 as CreateInput, b2 as GetForIdInput, b3 as GetOrCreateWithKeyInput, b4 as GetWithKeyInput, b5 as ListActorsInput, b6 as ManagerDisplayInformation } from '../config-Qj-zLJPc.js';
...
import { GetUpgradeWebSocket, Runtime } from '../utils.js';
...
declare function buildManagerRouter(config: RegistryConfig, managerDriver: ManagerDriver, getUpgradeWebSocket: GetUpgradeWebSocket | undefined, runtime?: Runtime): {
    router: Hono;
    openapi: _hono_zod_openapi.OpenAPIHono;
};
