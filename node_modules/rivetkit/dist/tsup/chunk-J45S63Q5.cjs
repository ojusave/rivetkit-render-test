...
function encodeWorkflowHistoryTransport(history) {
  return _chunk2Q5WS6QHcjs.bufferToArrayBuffer.call(void 0, encodeWorkflowHistory(history));
}
function decodeWorkflowHistoryTransport(data) {
  return decodeWorkflowHistory(_chunk2Q5WS6QHcjs.toUint8Array.call(void 0, data));
}
...
//# sourceMappingURL=chunk-J45S63Q5.cjs.map